...
class SContClass {
    ...
    public function contactStyles() {
        $theme = get_option('cont_active_theme');
        wp_register_style('spidercontacts_theme', plugins_url('css/themesCSS/sc_theme_'.$theme.'.css', __FILE__), $this->version, $this->version);
