			...
			<tbody>
				<tr>
					...
					<td class="paramlist_value">
						...
						<p class="paramlist_descriptions"><?php echo 'Choose whether to search contacts by categories in views or not.'; ?></p>
					</td>
				</tr>
				<tr>
					<?php
				...
				<tr>
					...
					<td class="paramlist_value">
						...
						<p class="paramlist_descriptions"><?php echo 'Choose whether to display image in lightbox or in new tab.'; ?></p>	
					</td>
				</tr>
				<tr>
					<th scope="row"><?php echo 'Slug ';?>:</th>
					<td> <input type="text" name="team_slug" value="<?php echo get_option('team_slug');?>"> </td>
				</tr>
			</tbody>
		</table>
