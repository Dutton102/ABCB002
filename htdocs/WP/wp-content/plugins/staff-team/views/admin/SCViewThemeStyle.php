...
<div id="cont_tabs">
        ...
        <div class="staff_view">
			<table class="paramlist admintable" cellspacing="1">
				...
				<tr>
					...
					$icon_check1 = "";
					if (isset($param_values['short_image_size']) && $param_values['short_image_size'] == 1) { $icon_check1 = ' checked="checked" '; $icon_check0 = '';}?>
					<td class="paramlist_key">
						<span class="editlinktip"><label id="params_icons_radius" for="params_icons_radius" title="Image style"><?php echo 'Image style';?></label></span>
					</td>
					<td class="paramlist_value">
						<input type="radio" name="params[short_image_size]" id="short_image_size_cover" value="0" <?php echo isset($icon_check0)?$icon_check0:''; ?>/>
						<label for="short_image_size_cover"><?php echo 'Cover';?></label>
						<input type="radio" name="params[short_image_size]" id="short_image_size_contain" value="1" <?php echo isset($icon_check1)?$icon_check1:''; ?>/>
						<label for="short_image_size_contain"><?php echo 'Contain';?></label>
					</td>
				</tr>
				<!--end new option-->
				<tr>
		...
		<div class="staff_view">
			<table  class="paramlist admintable" cellspacing="1">
				...
				<tr>
					...
					$icon_check0 = " checked='checked' ";
					$icon_check1 = "";
					if (isset($param_values['full_image_size']) && $param_values['full_image_size'] == 1) { $icon_check1 = ' checked="checked" '; $icon_check0 = '';}?>
					<td class="paramlist_key">
						<span class="editlinktip"><label id="params_icons_radius" for="params_icons_radius" title="Image style"><?php echo 'Image style';?></label></span>
					</td>
					<td class="paramlist_value">
						<input type="radio" name="params[full_image_size]" id="full_image_size_cover" value="0" <?php echo isset($icon_check0)?$icon_check0:''; ?>/>
						<label for="full_image_size_cover"><?php echo 'Cover';?></label>
						<input type="radio" name="params[full_image_size]" id="full_image_size_contain" value="1" <?php echo isset($icon_check1)?$icon_check1:''; ?>/>
						<label for="full_image_size_contain"><?php echo 'Contain';?></label>
					</td>
				</tr>
				<tr>
					<?php
					$icon_check0 = " checked='checked' ";
					$icon_check1 = "";
					if (isset($param_values['full_info_exerpt']) && $param_values['full_info_exerpt'] == 1) { $icon_check1 = ' checked="checked" '; $icon_check0 = '';}?>
					<td class="paramlist_key">
						<span class="editlinktip"><label id="params_icons_radius" for="params_icons_radius" title="Post content"><?php echo 'Post content';?></label></span>
					</td>
					<td class="paramlist_value">
						<input type="radio" name="params[full_info_exerpt]" id="info_exerpt" value="0" <?php echo isset($icon_check0)?$icon_check0:''; ?>/>
						<label for="info_exerpt"><?php echo 'Exerpt';?></label>
						<input type="radio" name="params[full_info_exerpt]" id="info_full" value="1" <?php echo isset($icon_check1)?$icon_check1:''; ?>/>
						<label for="info_full"><?php echo 'Full';?></label>
					</td>
				</tr>
				<!--end new option-->
				<tr>
        ...
        <div class="staff_view">
			<table  class="paramlist admintable" cellspacing="1">
				...
				<tr>
					...
					$icon_check0 = " checked='checked' ";
					$icon_check1 = "";
					if (isset($param_values['table_image_size']) && $param_values['table_image_size'] == 1) { $icon_check1 = ' checked="checked" '; $icon_check0 = '';}?>
					<td class="paramlist_key">
						<span class="editlinktip"><label id="params_icons_radius" for="params_icons_radius" title="Image style"><?php echo 'Image style';?></label></span>
					</td>
					<td class="paramlist_value">
						<input type="radio" name="params[table_image_size]" id="table_image_size_cover" value="0" <?php echo isset($icon_check0)?$icon_check0:''; ?>/>
						<label for="table_image_size_cover"><?php echo 'Cover';?></label>
						<input type="radio" name="params[table_image_size]" id="table_image_size_contain" value="1" <?php echo isset($icon_check1)?$icon_check1:''; ?>/>
						<label for="table_image_size_contain"><?php echo 'Contain';?></label>
					</td>
				</tr>
				<!--end new option-->
				<tr>
		...
		<div class="staff_view">
			<table  class="paramlist admintable" cellspacing="1">
				...
				<tr>
					...
					$icon_check0 = " checked='checked' ";
					$icon_check1 = "";
					if (isset($param_values['chess_image_size']) && $param_values['chess_image_size'] == 1) { $icon_check1 = ' checked="checked" '; $icon_check0 = '';}?>
					<td class="paramlist_key">
						<span class="editlinktip"><label id="params_icons_radius" for="params_icons_radius" title="Image style"><?php echo 'Image style';?></label></span>
					</td>
					<td class="paramlist_value">
						<input type="radio" name="params[chess_image_size]" id="chess_image_size_cover" value="0" <?php echo isset($icon_check0)?$icon_check0:''; ?>/>
						<label for="chess_image_size_cover"><?php echo 'Cover';?></label>
						<input type="radio" name="params[chess_image_size]" id="chess_image_size_contain" value="1" <?php echo isset($icon_check1)?$icon_check1:''; ?>/>
						<label for="chess_image_size_contain"><?php echo 'Contain';?></label>
					</td>
				</tr>
				<tr>
					<?php
					$icon_check0 = " checked='checked' ";
					$icon_check1 = "";
					if (isset($param_values['chess_info_exerpt']) && $param_values['chess_info_exerpt'] == 1) { $icon_check1 = ' checked="checked" '; $icon_check0 = '';}?>
					<td class="paramlist_key">
						<span class="editlinktip"><label id="params_icons_radius" for="params_icons_radius" title="Post content"><?php echo 'Post content';?></label></span>
					</td>
					<td class="paramlist_value">
						<input type="radio" name="params[chess_info_exerpt]" id="chess_info_exerpt" value="0" <?php echo isset($icon_check0)?$icon_check0:''; ?>/>
						<label for="chess_info_exerpt"><?php echo 'Exerpt';?></label>
						<input type="radio" name="params[chess_info_exerpt]" id="chess_info_full" value="1" <?php echo isset($icon_check1)?$icon_check1:''; ?>/>
						<label for="chess_info_full"><?php echo 'Full';?></label>
					</td>
				</tr>
				<!--end new option-->
				<tr>
    ...
    <div id="theme_style_port" class="adminform">
        ...
        <tr>
          ...
          $icon_check0 = " checked='checked' ";
          $icon_check1 = "";
          if (isset($param_values['portfolio_image_size']) && $param_values['portfolio_image_size'] == 1) { $icon_check1 = ' checked="checked" '; $icon_check0 = '';}?>
          <td class="paramlist_key">
            <span class="editlinktip"><label id="params_icons_radius" for="params_icons_radius" title="Image style"><?php echo 'Image style';?></label></span>
          </td>
          <td class="paramlist_value">
            <input type="radio" name="params[portfolio_image_size]" id="portfolio_image_size_cover" value="0" <?php echo isset($icon_check0)?$icon_check0:''; ?>/>
            <label for="portfolio_image_size_cover"><?php echo 'Cover';?></label>
            <input type="radio" name="params[portfolio_image_size]" id="portfolio_image_size_contain" value="1" <?php echo isset($icon_check1)?$icon_check1:''; ?>/>
            <label for="portfolio_image_size_contain"><?php echo 'Contain';?></label>
          </td>
        </tr>
        <!--end new option-->
        <tr>
		...
		<div class="staff_view">
			<table  class="paramlist admintable" cellspacing="1">
				...
				<tr>
					...
					$icon_check0 = " checked='checked' ";
					$icon_check1 = "";
					if (isset($param_values['blog_image_size']) && $param_values['blog_image_size'] == 1) { $icon_check1 = ' checked="checked" '; $icon_check0 = '';}?>
					<td class="paramlist_key">
						<span class="editlinktip"><label id="params_icons_radius" for="params_icons_radius" title="Image style"><?php echo 'Image style';?></label></span>
					</td>
					<td class="paramlist_value">
						<input type="radio" name="params[blog_image_size]" id="blog_image_size_cover" value="0" <?php echo isset($icon_check0)?$icon_check0:''; ?>/>
						<label for="blog_image_size_cover"><?php echo 'Cover';?></label>
						<input type="radio" name="params[blog_image_size]" id="blog_image_size_contain" value="1" <?php echo isset($icon_check1)?$icon_check1:''; ?>/>
						<label for="blog_image_size_contain"><?php echo 'Contain';?></label>
					</td>
				</tr>
				<tr>
					<?php
					$icon_check0 = " checked='checked' ";
					$icon_check1 = "";
					if (isset($param_values['blog_info_exerpt']) && $param_values['blog_info_exerpt'] == 1) { $icon_check1 = ' checked="checked" '; $icon_check0 = '';}?>
					<td class="paramlist_key">
						<span class="editlinktip"><label id="params_icons_radius" for="params_icons_radius" title="Post content"><?php echo 'Post content';?></label></span>
					</td>
					<td class="paramlist_value">
						<input type="radio" name="params[blog_info_exerpt]" id="blog_info_exerpt" value="0" <?php echo isset($icon_check0)?$icon_check0:''; ?>/>
						<label for="blog_info_exerpt"><?php echo 'Exerpt';?></label>
						<input type="radio" name="params[blog_info_exerpt]" id="blog_info_full" value="1" <?php echo isset($icon_check1)?$icon_check1:''; ?>/>
						<label for="blog_info_full"><?php echo 'Full';?></label>
					</td>
				</tr>
				<!--end new option-->
				<tr>
		...
		<div class="staff_view">
			<table class="paramlist admintable" cellspacing="1">
				...
				<tr>
					...
					$icon_check0 = " checked='checked' ";
					$icon_check1 = "";
					if (isset($param_values['circle_image_size']) && $param_values['circle_image_size'] == 1) { $icon_check1 = ' checked="checked" '; $icon_check0 = '';}?>
					<td class="paramlist_key">
						<span class="editlinktip"><label id="params_icons_radius" for="params_icons_radius" title="Image style"><?php echo 'Image style';?></label></span>
					</td>
					<td class="paramlist_value">
						<input type="radio" name="params[circle_image_size]" id="circle_image_size_cover" value="0" <?php echo isset($icon_check0)?$icon_check0:''; ?>/>
						<label for="circle_image_size_cover"><?php echo 'Cover';?></label>
						<input type="radio" name="params[circle_image_size]" id="circle_image_size_contain" value="1" <?php echo isset($icon_check1)?$icon_check1:''; ?>/>
						<label for="circle_image_size_contain"><?php echo 'Contain';?></label>
					</td>
				</tr>
				<tr>
					<?php
					$icon_check0 = " checked='checked' ";
					$icon_check1 = "";
					if (isset($param_values['circle_info_exerpt']) && $param_values['circle_info_exerpt'] == 1) { $icon_check1 = ' checked="checked" '; $icon_check0 = '';}?>
					<td class="paramlist_key">
						<span class="editlinktip"><label id="params_icons_radius" for="params_icons_radius" title="Post content"><?php echo 'Post content';?></label></span>
					</td>
					<td class="paramlist_value">
						<input type="radio" name="params[circle_info_exerpt]" id="circle_info_exerpt" value="0" <?php echo isset($icon_check0)?$icon_check0:''; ?>/>
						<label for="circle_info_exerpt"><?php echo 'Exerpt';?></label>
						<input type="radio" name="params[circle_info_exerpt]" id="circle_info_full" value="1" <?php echo isset($icon_check1)?$icon_check1:''; ?>/>
						<label for="circle_info_full"><?php echo 'Full';?></label>
					</td>
				</tr>
				<!--end new option-->
				<tr>
		...
		<div class="staff_view">
			<table  class="paramlist admintable" cellspacing="1">
				...
				<tr>
					...
					$icon_check0 = " checked='checked' ";
					$icon_check1 = "";
					if (isset($param_values['square_image_size']) && $param_values['square_image_size'] == 1) { $icon_check1 = ' checked="checked" '; $icon_check0 = '';}?>
					<td class="paramlist_key">
						<span class="editlinktip"><label id="params_icons_radius" for="params_icons_radius" title="Image style"><?php echo 'Image style';?></label></span>
					</td>
					<td class="paramlist_value">
						<input type="radio" name="params[square_image_size]" id="square_image_size_cover" value="0" <?php echo isset($icon_check0)?$icon_check0:''; ?>/>
						<label for="square_image_size_cover"><?php echo 'Cover';?></label>
						<input type="radio" name="params[square_image_size]" id="square_image_size_contain" value="1" <?php echo isset($icon_check1)?$icon_check1:''; ?>/>
						<label for="square_image_size_contain"><?php echo 'Contain';?></label>
					</td>
				</tr>
				<!--new option-->
				<tr>
			...
			<table  class="paramlist admintable" cellspacing="1">
				...
				<tr>
					...
					<td class="paramlist_value"><input type="text" name="params[single_image_width]" id="paramscube_single_image_width" value="<?php
						echo isset($param_values['single_image_width'])?$param_values['single_image_width']:'400'; ?>" class="text_area" size="4" />px</td>
				</tr>
				<tr>
					<?php
