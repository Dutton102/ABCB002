...
?>
	...
	<div class="wrap SC_start_ordering">
		...
		<table class="wp-list-table widefat fixed striped posts">
			<thead>
				<tr>
					<td id="cb" class="manage-column column-cb check-column" style="padding:0;"></td>
					<th><p><strong><span>ID</span></strong></p></th>
					<th><p><strong><span>Name</span></strong></p></th>
					<th><p><strong><span>Category</span></strong></p></th>
					<th><p><strong><span>Date</span></strong></p></th>
				</tr>
			</thead>
			...
			<tbody id="the-list" class="order_list ui-sortable">
				...
				if(is_array($contactList) && count($contactList)>0){
					...
					echo'<tr class="no-items"><td class="colspanchange" colspan="3">No posts found.</td></tr>';
				}
				?>
			</tbody>
			...
			<tfoot>
				<tr>
					<td id="cb" class="twd_manage_column manage-column column-cb check-column"></td>
					<th><p><strong><span>ID</span></strong></p></th>
					<th><p><strong><span>Name</span></strong></p></th>
					<th><p><strong><span>Category</span></strong></p></th>
					<th><p><strong><span>Date</span></strong></p></th>
