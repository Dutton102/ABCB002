...
function sc_uninstall_plugin(){
    ...
    //            $delete_options = array('name_search','lightbox','enable_message','show_name','show_email','show_phone','show_cont_pref','cont_active_theme');
    ...
    if($delete_demo_data) {
        ...
        delete_option('cont_plugin_registered');
