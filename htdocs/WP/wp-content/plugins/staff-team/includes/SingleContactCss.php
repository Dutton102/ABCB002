...
<?php echo '.' . $theme . ' #single_contact '; ?>
.img_content {
	margin:0 <?php echo isset($param_values['single_image_middle']) && $param_values['single_image_middle'] == '1' ? '0%' : 'auto'; ?>;
...
.single_cont_main_picture {
	...
	background-size:<?php echo isset($param_values['single_image_middle']) && $param_values['single_image_middle'] == '1' ? '100%' : '95%'; ?>;
}
...
<?php
	...
	<?php echo '.' . $theme . ' #single_contact '; ?>
	.img_content {
		width: <?php echo isset($param_values['single_image_width']) ? $param_values['single_image_width'] : '400'; ?>px;
		height: <?php echo ((isset($param_values['single_image_width']) ? $param_values['single_image_width'] : '430')-60); ?>px;
	}
	<?php echo '.' . $theme . ' #single_contact '; ?>
	.top_info{ 
		border-bottom:1px <?php echo isset($param_values['single_border_style']) ? $param_values['single_border_style'] : 'solid'; ?> <?php echo isset($param_values['single_border_color']) ? $param_values['single_border_color'] : '#D9D9D9'; ?>;
