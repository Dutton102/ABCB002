...
<?php echo '.' . $theme . ' #full_contact '; ?>
<?php
  if(isset($param_values["full_info_exerpt"]) && intval($param_values["full_info_exerpt"]) ===1){
    $overflow = "auto";
  }else{
    $overflow = "hidden";
  }
...
<?php
  if(isset($param_values["full_image_size"]) && intval($param_values["full_image_size"]) ===1){
    $background_size = "contain";
  }else{
    $background_size = "cover";
  }
?>
<?php echo '.' . $theme;?> #full_contact .full_cont_main_picture{
